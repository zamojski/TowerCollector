...
Tower Collector expone las tareas que deben ejecutar otras aplicaciones que
envían *intents* como Tasker, Automate o Llama. Debe usar el tipo *Broadcast*
para todas las actividades definidas a continuación. Para obtener más
información sobre cómo realizar dicha comprobación de integración las
aplicaciones ayudan. *Al igual que dentro de la aplicación, ¡no puedes iniciar
...
La exportación se iniciará utilizando la configuración de la última ejecución,
las mediciones se mantendrán. Acción:
...
En Android Oreo y versiones posteriores, debe definir adicionalmente el nombre
del paquete del componente:
