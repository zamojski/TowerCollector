...
ל־Tower Collector יש אפשרות להודיע ליישומונים אחרים שמותקנים במערכת על ידי שידור
*intents*. למידע נוסף על האזנה אליהם וצריכתם כמו התראות יש לעיין בעזרה של
היישומון.

### אירוע מדידות שנאספו

מנגנון האיסוף יכול לשלוח intent בכל פעם שסדרה חדשה של בדיקות נאספת אם כך הוגדר
בהגדרות. התוכן של ההתראות יהיה במבנה JSON עם דברים משותפים כמו זמן ו־GPS
שיחולצו. שמות השדות והערכים ממופים באותו האופן כמו בקובץ CSV.

רשימת השדות בשימוש האנטנות תלויה בסוג (net_type). ערכים בלתי נתמכים או חסרים
יוגדרו לכדי `null`.
