...
이 앱은 장치 기지국 정보와 GPS 좌표를 수집하도록 설계되었습니다.

### 시작하는 방법

수집을 시작하려면 화면 상단의 메뉴에서 \'수집 시작(녹화 아이콘)\'을 선택합니다. 데이터 수집은 모바일 네트워크에 연결되어 있고 GPS 정확도가 최소 40m 정확도 이내일 때 수집됩니다.
...
설정의 정보 섹션에서 추가 정보 및 모범 사례를 볼 수 있습니다.