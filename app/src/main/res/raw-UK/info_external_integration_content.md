...
Колектор сот виставляє завдання для запуску інших програм, які надсилають
*intents*, як Tasker, Automate або Llama. Вам потрібно використовувати тип
*Broadcast* для всіх дій, визначених нижче. Для отримання додаткової інформації
про те, як зробити таку інтеграцію перевірити інструкцію програми *Як у додатку,
ви не можете розпочати більше одного завдання одночасно!*

### Запуск колектора

Колектор буде запущений з використанням параметрів, визначених у Параметрах.
Дія:
...
Експорт розпочнеться з використанням конфігурації з останнього запуску, виміри
будуть збережені. Дія:
