...
final class TemporaryMeasurementsTable implements ITable {

    static final String TABLE_NAME = "temporary_measurements";
    ...
    static final String QUERY_CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + " ("
            ...
            + "FOREIGN KEY(" + COLUMN_LOCATION_ID + ") REFERENCES " + TemporaryLocationsTable.TABLE_NAME + "(" + TemporaryLocationsTable.COLUMN_ROW_ID + "),"
            + "FOREIGN KEY(" + COLUMN_CELL_ID + ") REFERENCES " + TemporaryCellsTable.TABLE_NAME + "(" + TemporaryCellsTable.COLUMN_ROW_ID + "))";
