...
public class T0stUploadClient extends ClientBase implements IUploadClient {

    private static final MediaType CSV = MediaType.parse("text/csv");

    private final String uploadUrl;
    private final String uploadContributor;
    private long fileSize;

    public T0stUploadClient(String url, String contributor) {
        this.uploadUrl = url;
        this.uploadContributor = contributor;
    }
    ...
    private RequestResult uploadMeasurementsEncrypted(String content) {
        ...
        return uploadMeasurementsCommon(new ExtendedOkHttpClientBuilder().newBuilder(), uploadUrl, uploadContributor, content);
    }

    private RequestResult uploadMeasurementsCommon(OkHttpClient.Builder clientBuilder, String url, String contributor, String content) {
        try {
            ...
            RequestBody requestBody = new MultipartBody.Builder()
                    ...
                    .addFormDataPart("key", contributor)
